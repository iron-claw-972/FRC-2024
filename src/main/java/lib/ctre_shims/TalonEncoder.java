...
public class TalonEncoder implements Sendable, AutoCloseable {
    ...
    public double getPeriod() {
        ...
        return distancePerPulse / getRate();
    }
    ...
    public double getRate() {
        return motor.getSelectedSensorVelocity() * 10 * distancePerPulse;
    }
     ...
     * <a href="https://docs.ctre-phoenix.com/en/stable/ch14_MCSensor.html#changing-velocity-measurement-parameters">here</a>
    ...
    public void setSamplesToAverage(int samplesToAverage) {
        ...
        motor.configVelocityMeasurementWindow(samplesToAverage);
    }
    ...
    public int getSamplesToAverage() {
        return (int) motor.configGetParameter(ParamEnum.eSampleVelocityWindow, 0);
    }
    ...
    public FeedbackDevice getSelectedFeedbackSensor() {
        return FeedbackDevice.valueOf(motor.configGetParameter(ParamEnum.eFeedbackSensorType, 0));
    }
